...
- **Sökväg:** `public/data/politics/parliament/debates/index.json` (1 fil; 108 rader).
...
- **Sökväg:** `public/data/politics/parliament/debates/*/*.json` (108 filer; 10 148 rader).
...
- **Sökväg:** `public/data/politics/parliament/issues/index.json` (1 fil; 31 rader).
...
- **Sökväg:** `public/data/politics/parliament/issues/*/index.json` (31 filer; 6 224 rader).
...
- **Sökväg:** `public/data/politics/parliament/issues/*/*.json` (1410 filer; 125 408 rader).
...
- **Sökväg:** `public/data/politics/parliament/speakers/summary.json` (1 fil; 113 rader).
...
- **Sökväg:** `public/data/politics/parliament/topics/summary.json` (1 fil; 26 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/topics.json` (33 filer; 3 784 rader).
...
- **Sökväg:** `public/data/politics/parliament/parties/*/topics.json` (9 filer; 3 784 rader).
- **Kornighet:** Parti × riksmöte × ämne. **Nyckel/referens:** `session + party + topic_id + modellversion`.
- **Kolumner (8):** `session`, `session_year`, `party`, `topic_id`, `topic_label`, `segments`, `words`, `word_share_pct`.

### UMAP-sampel · ny modell

- **Sökväg:** `public/data/politics/parliament/sessions/*/umap.json` (33 filer; 13 200 rader).
...
- **Sökväg:** `public/data/politics/parliament/similarity/top.json` (1 fil; 500 rader).
...
- **Sökväg:** `public/data/politics/parliament/parties/*/words.json` (9 filer; 892 rader).
...
- **Sökväg:** `public/data/politics/parliament/parties/*/mentions.json` (9 filer; 1 291 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decisions/*/points.json` (32 filer; 4 407 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decisions/index.json` (2 filer; 32 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decisions/*/citations.json` (32 filer; 18 505 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decisions/*/reservations.json` (32 filer; 7 503 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decisions/debate-traces.json` (2 filer; 933 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/votes.json` (2 filer; 11 488 rader).
...
- **Sökväg:** `public/data/politics/parliament/votes/summary.json` (1 fil; 16 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decision-motions.json` (2 filer; 5 367 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/decision-speech-links.json` (2 filer; 933 rader).
...
- **Sökväg:** `public/data/politics/parliament/activities/summary.json` (1 fil; 16 rader).
- **Kornighet:** Riksmöte × parti. **Nyckel/referens:** `session + party`.
- **Kolumner (5):** `session`, `party`, `written_questions`, `interpellations`, `debate_speeches`.

### Skriftliga frågor

- **Sökväg:** `public/data/politics/parliament/sessions/*/activities/questions.json` (2 filer; 2 434 rader).
...
- **Sökväg:** `public/data/politics/parliament/sessions/*/activities/interpellations.json` (2 filer; 1 343 rader).
- **Kornighet:** Ett dokument. **Nyckel/referens:** `document_id`.
- **Kolumner (12):** `document_id`, `session`, `document_type`, `designation`, `document_date`, `title`, `subtitle`, `actor_party`, `government_department`, `status`, `source_url`, `explicitly_cited_decision_points`.

### Propositioner

- **Sökväg:** `public/data/politics/parliament/sessions/*/activities/propositions.json` (2 filer; 577 rader).
- **Kornighet:** Ett dokument. **Nyckel/referens:** `document_id`.
- **Kolumner (12):** `document_id`, `session`, `document_type`, `designation`, `document_date`, `title`, `subtitle`, `actor_party`, `government_department`, `status`, `source_url`, `explicitly_cited_decision_points`.

### Budgetförslag · ursprunglig upstream-export

- **Sökväg:** `public/data/politics/parliament/budgets/summary.json` (1 fil; 1 104 rader).
...
- **Sökväg:** `public/data/politics/parliament/budgets/speech-alignment.json` (1 fil; 897 rader).
...
- **Sökväg:** `public/data/politics/parliament/budgets/execution.json` (1 fil; 1 104 rader).
- **Kornighet:** Riksmöte × aktör × utgiftsområde. **Nyckel/referens:** `session + actor + expenditure_area`.
...
- **Sökväg:** `public/data/politics/parliament/budgets/outturn-areas.json` (1 fil; 783 rader).
...
- **Sökväg:** `public/data/politics/parliament/laws/index.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/politics/parliament/laws/*/provisions.json` (1 fil; 92 rader).
...
- **Sökväg:** `public/data/politics/parliament/laws/mentions.json` (1 fil; 21 rader).
...
- **Sökväg:** `public/data/politics/parliament/legislative/proposition-committee-links.json` (1 fil; 393 rader).
...
- **Sökväg:** `public/data/politics/parliament/legislative/comparisons.json` (1 fil; 2 rader).
...
- **Sökväg:** `public/data/politics/decisions/*/index.json` (2 filer; 1 436 rader).
...
- **Sökväg:** `public/data/politics/decisions/*/*.json` (1436 filer; 1 436 rader).
...
- **Sökväg:** `public/data/politics/laws/index.json` (1 fil; 516 rader).
- **Kornighet:** En dokumentversion i en pool. **Nyckel/referens:** `pool + id`.
- **Kolumner (6):** `id`, `pool`, `title`, `version`, `provisions`, `path`.

### Lagbestämmelser · v1

- **Sökväg:** `public/data/politics/laws/v1/*.json` (50 filer; 1 952 rader).
...
- **Sökväg:** `public/data/politics/laws/v2/*.json` (466 filer; 18 836 rader).
...
- **Sökväg:** `public/data/debates/budgets/summary.json` (1 fil; 1 104 rader).
- **Kornighet:** Riksmöte × aktör × utgiftsområde. **Nyckel/referens:** `session + actor + expenditure_area`.
...
- **Sökväg:** `public/data/debates/budgets/speech-alignment.json` (1 fil; 897 rader).
- **Kornighet:** Riksmöte × parti × utgiftsområde. **Nyckel/referens:** `session + party + expenditure_area`.
...
- **Sökväg:** `public/data/debates/budgets/speech-keywords-all-parties.json` (1 fil; 2 592 rader).
- **Kornighet:** Riksmöte × parti × utgiftsområde. **Nyckel/referens:** `session + party + expenditure_area`.
- **Kolumner (5):** `session`, `party`, `expenditure_area`, `occurrences`, `keyword_share_pct`.

### Budgetårsurval

- **Sökväg:** `public/data/debates/budgets/year-selection-audit.json` (1 fil; 8 rader).
...
- **Sökväg:** `public/data/debates/budgets/coverage.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/reports/budget-language.json` (1 fil; 10 368 rader).
...
- **Sökväg:** `public/data/reports/budget-language.json` (1 fil; 384 rader).
...
- **Sökväg:** `public/data/reports/budget-language.json` (1 fil; 71 rader).
...
- **Sökväg:** `public/data/reports/rfc-drift.json` (1 fil; 2 rader).
- **Kornighet:** En RFC-version. **Nyckel/referens:** `rfc`.
- **Kolumner (6):** `rfc`, `sha256`, `url`, `requirements`, `counts`, `shares_pct`.

### RFC: motorexempel

- **Sökväg:** `public/data/reports/rfc-drift.json` (1 fil; 3 rader).
...
- **Sökväg:** `public/data/jobs/05_junior_by_month.csv` (1 fil; 187 rader).
...
- **Sökväg:** `public/data/jobs/06_top_technologies.csv` (1 fil; 64 rader).
...
- **Sökväg:** `public/data/politics/catalog.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/politics/overview.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/politics/parliament/overview.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/politics/parliament/manifest.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/politics/meaning.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/reports/manifest.json` (1 fil; 1 rad).
...
- **Sökväg:** `public/data/debates/overview.json` (1 fil; 1 rad).
- **Kornighet:** En genererad översikt. **Nyckel/referens:** `ingen observationsnyckel`.
- **Kolumner (3):** `schema_version`, `generated_at`, `data`.
...
- **Sökväg:** `data/allegoria/sources-v1/bronze/sfs/*.json` (50 filer; 50 rader).
...
- **Sökväg:** `data/allegoria/sources-v2/bronze/*.json` (496 filer; 496 rader).
- **Kornighet:** Ett källsnapshot av lagtext. **Nyckel/referens:** `document_snapshot_id`.
- **Kolumner (19):** `document_snapshot_id`, `document_id`, `designation`, `title`, `version`, `department`, `source_type`, `source_subtype`, `issued_at`, `published_at`, `retrieved_at`, `source_page_url`, `source_data_url`, `source_raw_file`, `source_sha256`, `payload_size_bytes`, `text`, `html`, `raw_xml`.

### Allegoria: v2 urvalsmanifest

- **Sökväg:** `data/allegoria/sources-v2/document_ids.json` (1 fil; 1 rad).
